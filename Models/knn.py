...
class KNN():
    ...
    model (KNeighborsClassifier): The model object that will be trained and evaluated.
    """

    def __init__(self, data_dir, datasets, name="K-Nearest Neighbors", random_state=42):
        """

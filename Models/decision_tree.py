...
class Decision_Tree():
    ...
    model (DecisionTreeClassifier): The model object that will be trained and evaluated.
    """

    def __init__(self, data_dir, datasets, name="Decision Tree", random_state=42):
        """
